...
export default {
  ...
  apiList: {
    init: {
      ...
      path: '/api/system/auth/OrganizationControl/init',
      type: 'post',
      JoiSchema: {},
    },
    search: {
      ...
      tags: ['OrganizationControl'],
      path: '/api/system/auth/OrganizationControl/search',
      type: 'post',
      JoiSchema: {
        body: {
    ...
    add: {
      ...
      tags: ['OrganizationControl'],
      path: '/api/system/auth/OrganizationControl/add',
      type: 'post',
      JoiSchema: {
        body: {
    ...
    getOrganizationMenu: {
      ...
      tags: ['OrganizationControl'],
      path: '/api/system/auth/OrganizationControl/getOrganizationMenu',
      type: 'post',
      JoiSchema: {
        body: {
    ...
    addFolder: {
      ...
      tags: ['OrganizationControl'],
      path: '/api/system/auth/OrganizationControl/addFolder',
      type: 'post',
      JoiSchema: {
        body: {
          organization_id: Joi.number().integer(),
    ...
    addMenus: {
      ...
      tags: ['OrganizationControl'],
      path: '/api/system/auth/OrganizationControl/addMenus',
      type: 'post',
      JoiSchema: {
        body: {
          organization_id: Joi.number().integer(),
    ...
    removeItem: {
      ...
      tags: ['OrganizationControl'],
      path: '/api/system/auth/OrganizationControl/removeItem',
      type: 'post',
      JoiSchema: {
        body: {
