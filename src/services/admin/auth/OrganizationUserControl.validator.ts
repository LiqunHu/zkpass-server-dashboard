...
export default {
  ...
  apiList: {
    init: {
      ...
      path: '/api/system/auth/OrganizationUserControl/init',
      type: 'post',
      JoiSchema: {},
    },
    search: {
      ...
      tags: ['OrganizationUserControl'],
      path: '/api/system/auth/OrganizationUserControl/search',
      type: 'post',
      JoiSchema: {
        body: {
    ...
    add: {
      ...
      tags: ['OrganizationUserControl'],
      path: '/api/system/auth/OrganizationUserControl/add',
      type: 'post',
      JoiSchema: {
        body: {
    ...
    modify: {
      ...
      tags: ['OrganizationUserControl'],
      path: '/api/system/auth/OrganizationUserControl/modify',
      type: 'post',
      JoiSchema: {
        body: {
    ...
    delete: {
      ...
      tags: ['OrganizationUserControl'],
      path: '/api/system/auth/OrganizationUserControl/delete',
      type: 'post',
      JoiSchema: {
        body: {
          user_id: Joi.string().max(50),
