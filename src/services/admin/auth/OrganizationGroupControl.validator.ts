...
export default {
  ...
  apiList: {
    init: {
      ...
      path: '/api/system/auth/OrganizationGroupControl/init',
      type: 'post',
      JoiSchema: {},
    },
    search: {
      ...
      tags: ['OrganizationGroupControl'],
      path: '/api/system/auth/OrganizationGroupControl/search',
      type: 'post',
      JoiSchema: {},
    },
    getcheck: {
      ...
      tags: ['OrganizationGroupControl'],
      path: '/api/system/auth/OrganizationGroupControl/getcheck',
      type: 'post',
      JoiSchema: {
        body: {
    ...
    add: {
      ...
      tags: ['OrganizationGroupControl'],
      path: '/api/system/auth/OrganizationGroupControl/add',
      type: 'post',
      JoiSchema: {
        body: {
    ...
    modify: {
      ...
      tags: ['OrganizationGroupControl'],
      path: '/api/system/auth/OrganizationGroupControl/modify',
      type: 'post',
      JoiSchema: {
        body: {
    ...
    remove: {
      ...
      tags: ['OrganizationGroupControl'],
      path: '/api/system/auth/OrganizationGroupControl/remove',
      type: 'post',
      JoiSchema: {
        body: {
          usergroup_id: Joi.number().integer(),
